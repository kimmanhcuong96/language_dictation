...
interface Props { src: string; startMs: number; endMs: number; playbackRate?: number; repeat?: boolean; repeatDelayMs?: number; paddingMs?: number; onError?: () => void; }
...
export const AudioSegmentPlayer = forwardRef<AudioSegmentPlayerHandle, Props>(function AudioSegmentPlayer({ src, startMs, endMs, playbackRate = 1, repeat = false, repeatDelayMs = 0, paddingMs = 50, onError }, ref) {
